        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role='combobox'
                    aria-expanded={open}
                    className={`w-full min-w-[120px] sm:min-w-[220px] h-8 sm:h-10 py-1 sm:py-2 px-2 sm:px-4 rounded-lg sm:rounded-xl flex items-center justify-between transition-all duration-300 overflow-hidden ${
                        theme === 'dark'
                ...
                >
                    <div className='flex flex-col items-start min-w-0 flex-1 overflow-hidden'>
                        <span
                            className={`text-[6px] sm:text-[9px] font-black uppercase tracking-[0.2em] mb-0 hidden xs:block ${theme === 'dark' ? 'text-blue-400/80' : 'text-blue-600'}`}
                        >
                            Market
                        </span>
