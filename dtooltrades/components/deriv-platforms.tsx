        ...
        >
            <div className='flex flex-col items-center justify-center min-h-[60vh] text-center'>
                ...
                <p className={`mb-6 text-base max-w-2xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                    Automate your trades with Deriv Bot. Build custom trading strategies using our visual block-based
                    interface, or choose from pre-built strategies to get started quickly.
                </p>
