                                ...
                                <div className='flex-1'>
                                    ...
                                    <div className='grid grid-cols-2 gap-2 mt-2'>
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <span
                                                className={`text-sm font-bold ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`}
                                            >
                                    ...
                                    {market.last100Digits.length === 100 && (
                                        <div className='mt-2 flex flex-wrap gap-2'>
                                            ...
                                            >
                                                U:{market.analysis.under.percentage}% O:
                                ...
                                {tradeSignals.map((signal, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    className={`text-xs font-bold mb-2 ${textColors[signal.category]}`}
                                                >
                                                    Conditions:
                                                </div>
                                            ...
                                            <div className='text-center'>
                                                ...
                                                <div className={`text-xl font-bold ${textColors[signal.category]}`}>
                                                    {signal.confidence}%
                                                </div>
                                            </div>
                                        </div>
