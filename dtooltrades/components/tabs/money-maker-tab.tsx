        ...
        <div className='space-y-6'>
            ...
            >
                ...
                {signal.status === 'RUN NOW' && signal.entryPoint && (
                    ...
                    >
                        <h3
                            className={`text-lg font-bold mb-2 ${theme === 'dark' ? 'text-orange-300' : 'text-orange-800'}`}
                        >
                            📍 Entry Point
                        </h3>
            ...
            >
                ...
                >
                    <span className='font-bold'>How Advanced Over/Under Works:</span> Phase 1 analyzes initial market
