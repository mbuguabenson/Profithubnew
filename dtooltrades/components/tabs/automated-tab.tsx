        ...
        <div className='space-y-3 sm:space-y-6'>
            ...
            >
                ...
                <CardContent className='p-3 sm:p-6 pt-0 sm:pt-0'>
                    <p
                        className={`text-sm sm:text-2xl font-bold mt-1 sm:mt-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                    >
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                        {BOT_STRATEGIES.map(strategy => (
                            <div
                                ...
                                className={`p-2.5 sm:p-4 rounded-lg border cursor-pointer transition-all ${
                            ...
                            >
                                <h3
                                    className={`text-xs sm:text-base font-bold mb-1 sm:mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                                >
                                    {strategy.name}
                                </h3>
                                <p
                ...
                <CardContent className='p-3 sm:p-6 pt-0 sm:pt-0 space-y-3 sm:space-y-4'>
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                        <div className='space-y-1 sm:space-y-2'>
                            <Label
                                className={`text-[10px] sm:text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
                            >
                                Stake ($)
                            </Label>
                            <Input
                                ...
                                onChange={e =>
                                    setConfig({ ...config, initialStake: Number.parseFloat(e.target.value) })
                                }
                                disabled={isRunning}
                        ...
                        <div className='space-y-1 sm:space-y-2'>
                            ...
                            <Input
                                ...
                                onChange={e =>
                                    setConfig({ ...config, martingaleMultiplier: Number.parseFloat(e.target.value) })
                                }
