...
const Cards = observer(({ search_query, handleTabChange }: TCardProps) => {
    ...
    const quickAccessItems: QuickAccessItem[] = [
        ...
        },
        {
            ...
            description: localize('Professional AI Bots and Super Rise/Fall automation'),
            tabIndex: DBOT_TABS.AI_BOT_BUILDER,
            tag: localize('Pro'),
            tagType: 'pro',
        },
        {
        ...
        {
            id: 'trading-tools',
            title: localize('Trading Tools'),
            icon: LabelPairedCircleDotCaptionRegularIcon,
            description: localize('Digit Cracker and specialized AI analysis tools'),
            tabIndex: DBOT_TABS.TRADING_TOOLS,
            tag: localize('New'),
            tagType: 'hot',
        },
    ];
