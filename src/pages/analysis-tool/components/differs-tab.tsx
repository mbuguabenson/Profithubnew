...
const DiffersTab = observer(() => {
    ...
    const [selected_prediction, setSelectedPrediction] = useState(0);
    ...
    return (
        <div className='differs-tab'>
                    ...
                    return (
                        <div
                            ...
                            className={classNames('differ-card', {
                                active: selected_prediction === differ.digit,
                                strong: differ.confidence === 'STRONG',
                                medium: differ.confidence === 'MEDIUM',
                            })}
                            onClick={() => setSelectedPrediction(differ.digit)}
                        >
            ...
            <div className='signal-display-section'>
            ...
            <div className='visual-timeline'>
                ...
                <div className='timeline-grid'>
                    {ticks.slice(-40).map((digit, idx) => {
                        ...
                        const isTarget = digit === selected_prediction;
