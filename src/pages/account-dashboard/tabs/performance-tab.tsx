        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="glass-card p-6 rounded-3xl group relative overflow-hidden">
                    ...
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2"><Localize i18n_default_text="Total Wins" /></p>
                ...
                <div className="glass-card p-6 rounded-3xl group relative overflow-hidden">
                    ...
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2"><Localize i18n_default_text="Total Losses" /></p>
                    <h3 className="text-3xl font-bold text-red-400">{stats.losses}</h3>
                </div>
                <div className="glass-card p-6 rounded-3xl group relative overflow-hidden">
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2"><Localize i18n_default_text="Net P/L" /></p>
                    <h3 className={classNames(
                        "text-3xl font-bold",
                        (stats.totalProfit - stats.totalLoss) >= 0 ? "text-emerald-400" : "text-red-400"
                    )}>
                        USD {(stats.totalProfit - stats.totalLoss).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                    </h3>
                </div>
                <div className="glass-card p-6 rounded-3xl group relative overflow-hidden">
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2"><Localize i18n_default_text="Total Trades" /></p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 glass-card p-8 rounded-3xl flex flex-col items-center justify-center min-h-[400px]">
                    <h3 className="text-lg font-bold text-white mb-8"><Localize i18n_default_text="Win Rate Breakdown" /></h3>
                    <div className="relative w-full aspect-square">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                            ...
                            <span className="text-slate-500 text-xs uppercase tracking-widest font-bold"><Localize i18n_default_text="Accuracy" /></span>
                        </div>
                    </div>
                    ...
                    <div className="w-full mt-8 space-y-4">
                        <div className="flex justify-between items-end">
                            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest"><Localize i18n_default_text="Success Ratio" /></span>
                ...
                <div className="lg:col-span-2 glass-card p-8 rounded-3xl">
                    <div className="flex items-center justify-between mb-8">
                        <h3 className="text-xl font-bold text-white"><Localize i18n_default_text="Trading Journal Feed" /></h3>
                    ...
                    <div className="space-y-4 max-h-[450px] overflow-y-auto pr-2 custom-scrollbar">
                        {MOCK_TRADES.map((trade, idx) => (
                            <div key={idx} className="glass-card-hover bg-white/5 p-4 rounded-xl border border-white/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    <div className={classNames(
                                        "w-10 h-10 rounded-xl flex items-center justify-center",
                                        trade.result === 'Win' ? "bg-emerald-500/20 text-emerald-400" : "bg-red-500/20 text-red-400"
                                    )}>
                                        {trade.result === 'Win' ? (
                                ...
                                <div className="flex flex-wrap gap-x-8 gap-y-2">
                                    <div>
                                        <p className="text-[10px] uppercase text-slate-500 font-bold tracking-widest"><Localize i18n_default_text="Entry → Exit" /></p>
                                        <p className="text-xs font-mono text-slate-300">{trade.entry} → {trade.exit}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[10px] uppercase text-slate-500 font-bold tracking-widest"><Localize i18n_default_text="Profit/Loss" /></p>
